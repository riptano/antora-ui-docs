# GCX-SCHEMA component

This project contains the Web Components `gcx-schema-bottom-sidebar`, `gcx-schema-topbar`, `gcx-schema-sample-app-gallery` which are integrated into [antora-ui-dcos](https://github.com/riptano/antora-ui-docs).
...
Clone the bitbucket.org/edwini/gcx-schema project using git:

```
$ git clone git@bitbucket.org:edwini/gcx-schema.git &&
cd "`basename $_`"
```
...
After build the component you will find the output into the folter `www/build` you can copy and paste this whole content into the folter `antora-ui-docs/src/js/vendor/gcx-schema`.
...
```
{
      type: "www",
      empty: true,
      buildDir:"/Users/user/documents/antora-ui-docs/src/js/vendor/gcx-schema",
