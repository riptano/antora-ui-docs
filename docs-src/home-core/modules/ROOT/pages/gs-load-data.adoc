...
* xref:manage:upload/astra-data-loader.adoc[Data Loader feature in Astra console], which presents options to load CSV data; or load data from the provided sample datasets; or load data from your Amazon S3 bucket that contains exported DynamoDB data.
