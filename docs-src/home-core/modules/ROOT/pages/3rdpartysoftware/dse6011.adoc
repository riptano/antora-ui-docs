= DataStax Enterprise 6.0.11 third-party software

//shortdesc: Third-party software licensed for DataStax Enterprise 6.0.11.
...
| AOP Alliance Version 1.0 Repackaged as a Module
| 2.5.0
| EPL 2.0
