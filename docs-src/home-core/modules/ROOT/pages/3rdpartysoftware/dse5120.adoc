= DataStax Enterprise 5.1.20 third-party software

//shortdesc: DSE 5.1.20 third-party software.
...
| ehcache
| 2.8.5
| CDDL-1.0; Multi-license: GPL-2.0-only OR GPL-2.0-with-classpath-exception; Apache
              License, Version 2.0
