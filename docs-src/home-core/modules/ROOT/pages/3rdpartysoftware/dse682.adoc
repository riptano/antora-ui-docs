= DataStax Enterprise 6.8.2 third-party software

//shortdesc: Third-party software licensed for DataStax Enterprise 6.8.2.
...
| matplotlib
| 3.3.0
| MIT; OFL-1.1; BSD-3-Clause; BSD-3-Clause; Python-2.0; LGPL-3.0-only; Apache
