= DataStax Enterprise 6.8.3 third-party software

//shortdesc: Third-party software licensed for DataStax Enterprise 6.8.3.
...
| matplotlib
| 3.3.2
| MIT; OFL-1.1; BSD-3-Clause; Multi-license: BSD-3-Clause OR LGPL-3.0-only;
              Python-2.0; Apache License, Version 2.0; MPL-2.0
