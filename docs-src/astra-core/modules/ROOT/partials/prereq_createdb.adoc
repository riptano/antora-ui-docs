...
. If you don’t have an existing plan, select the free plan or a plan with annual savings. See xref:manage:org/managing-org.adoc#_plan_selection[plan options] for the benefits of each plan. You can upgrade from a pay as you go plan to a committed plan as your needs might change.
+
[NOTE]
