...
image::ROOT:sso_workflow_line.png[]
...
* xref:manage:org/sso-azure.adoc[Microsoft Azure AD]
* xref:manage:org/sso-okta.adoc[Okta]
* xref:manage:org/sso-onelogin.adoc[OneLogin]
//* xref:manage:org/sso-other.adoc[Other]
