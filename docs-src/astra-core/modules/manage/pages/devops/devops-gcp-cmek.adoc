...
** AWS - supported via xref:manage:devops/devops-aws-cmk.adoc[BYOK AWS with DevOps API] and xref:manage:org/byok-ui-aws.adoc[BYOK AWS with {astra_ui}].
** Google Cloud - supported via BYOK GCP with DevOps API (this topic), and xref:manage:org/byok-ui-gcp.adoc[BYOK GCP with {astra_ui}].
...
. xref:manage:db/manage-create.adoc[Create your {astra_db} database] using {astra_ui}. For the examples in this topic, in the case of this BYOK feature, create a Google Cloud based database, and choose one of the available regions to start.
...
. Create an xref:manage:org/manage-tokens.adoc[application token] to https://docs.datastax.com/en/astra/docs/_attachments/devopsv2.html[authenticate your service account] in the DevOps API.
. Ensure you have xref:manage:org/user-permissions.adoc[permission] to create and view Customer Keys. See <<#_roles_and_permissions>>.
...
include::manage:partial$byok_gcp_kms_console.adoc[]
...
For descriptions of the `/v2/kms` calls, see the sections below. For more, see the https://docs.datastax.com/en/astra/docs/_attachments/devopsv2.html#tag/Customer-Keys[DevOps v2 API, window="_blank"] reference details.
...
----
include::manage:example$devops/cmk/curl_create_cmk_aws.sh[]
----
--
...
----
include::manage:example$results/cmk/devops_create_cmk_aws.result[]
----
--
====
...
[source,shell, subs="attributes+"]
----
include::manage:example$devops/cmk/curl_get_all_cmks.sh[]
----
--
...
[source,plaintext, subs="attributes+"]
----
include::manage:example$results/cmk/devops_get_all_cmks.result[]
----
--
====
...
[source,shell, subs="attributes+"]
----
include::manage:example$devops/cmk/curl_get_cmk_for_provider_and_region.sh[]
----
--
...
[source,plaintext, subs="attributes+"]
----
include::manage:example$results/cmk/devops_get_cmk_for_provider_and_region.result[]
----
--
====
