...
. Once you have authenticated your service account, you can add and remove IP addresses and CIDRs for your access list in the https://docs.datastax.com/en/astra/docs/_attachments/devopsv2.html[DevOps API].
...
====
+
For more, see https://docs.datastax.com/en/astra/docs/_attachments/devopsv2.html#operation/GetAllAccessListsForOrganization[Get all access lists for an organization] and https://docs.datastax.com/en/astra/docs/_attachments/devopsv2.html#operation/GetAccessListForDatabase[Get access list for a database] in the DevOps API.
...
+
For more, see https://docs.datastax.com/en/astra/docs/_attachments/devopsv2.html#operation/GetAccessListTemplate[Get template of access list] in the DevOps API.
...
+
For more, see https://docs.datastax.com/en/astra/docs/_attachments/devopsv2.html#operation/AddAddressesToAccessListForDatabase[Add addresses to access list for a database] in the DevOps API.
...
+
For more, see https://docs.datastax.com/en/astra/docs/_attachments/devopsv2.html#operation/UpsertAccessListForDatabase[Replace access list for your database] and https://docs.datastax.com/en/astra/docs/_attachments/devopsv2.html#operation/UpdateAccessListForDatabase[Update existing fields in access list for database] in the DevOps API.
...
For more, see https://docs.datastax.com/en/astra/docs/_attachments/devopsv2.html#operation/DeleteAddressesOrAccessListForDatabase[Delete addresses or access list for database] in the DevOps API.

=== What's next?

Explore the https://docs.datastax.com/en/astra/docs/_attachments/devopsv2.html[DevOps API].
