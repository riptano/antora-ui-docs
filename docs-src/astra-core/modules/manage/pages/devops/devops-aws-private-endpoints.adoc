...
For pricing related to using private endpoints, see xref:manage:org/managing-org.adoc#pricing-and-billing#private-endpoints[Pricing and billing].
...
. xref:manage:db/managing-db.adoc#create-your-astra-db-database[Create your {astra_db} database] using {astra_ui}.
. Ensure you have xref:manage:org/manage-permissions.adoc[permission] to manage private endpoints.
. xref:manage:org/managing-org.adoc#manage-application-tokens[Get your application token].
