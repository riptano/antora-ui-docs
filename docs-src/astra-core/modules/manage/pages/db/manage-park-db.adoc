...
When parking a database, the {company} Cloud console calculates the estimated cost of parking the database versus the cost of keeping the database running.
