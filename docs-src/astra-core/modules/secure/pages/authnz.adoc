...
:page-tag: security,astra-db,authentication,authorization
...
an auth token based on a https://cassandra.apache.org/doc/latest/operating/security.html#authentication[Cassandra username and password].
