...
To connect to your {astra_db} database using the drivers, download the secure database bundle from the {company} {astra_ui} that contains the connection credentials.
...
Although teammates can access your {astra_db} database, it will not display in their list of available databases under *My Databases* in {astra_ui}.
