...
[TIP]
====
Each {company} {astra_db} database includes an embedded CQL shell instance. In {astra_ui}, navigate to your database and click the CQL Console tab to open a CQLSH instance that is connected to your database.
====
...
include::page$secure-connect-bundle.adoc[Secure connect bundle, leveloffset=+3]
