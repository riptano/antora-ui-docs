...
. Follow the steps to get your xref:manage:org/managing-org.adoc#managing-application-tokens.adoc[application token, window="_blank"] and set up your environment variables. Or if you have an older Astra Classic database, follow the steps in xref:manage:org/managing-org.adoc#managing-classic-database-authentication[Authentication for classic databases, window="_blank"].
endif::[]