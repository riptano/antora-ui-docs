...
:url-site-local-home-yaml: https://github.com/riptano/docs-home/blob/main/playbooks/site-local-home.yaml#L20-L34
:url-site-publish-home-yaml: https://github.com/riptano/docs-home/blob/main/playbooks/site-publish-home.yaml#L20-L34
...
To ensure that we correctly deploy the latest search assets to the doc servers, we added `supplemental-ui` settings in the {url-site-local-home-yaml}[site-local-home.yaml] and {url-site-publish-home-yaml}[site-publish-home.yaml] playbooks.
