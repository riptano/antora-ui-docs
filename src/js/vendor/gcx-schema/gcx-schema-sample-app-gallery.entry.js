...
const GcxSchemaSampleAppGallery = class {
  ...
  render() {
    ...
    return (h("div", { class: "card" }, h("div", { class: "icon" }, this.schema.sampleAppGallery.icon), h("div", { class: "name" }, h("h4", null, this.schema.sampleAppGallery.title), h("p", null, this.schema.sampleAppGallery.content))));
  }
