...
Ensure the Source Attribute is in email format and maps to an attribute which matches the users's Astra account ID (or desired account ID for JIT provisioning).

image::ROOT:source_att.png[]
