...
. Open OneLogin and select *OpenId Connect (OIDC)*. This action opens your portal.

+
image::ROOT:onelg_OIDC.png[]

. Select the rectangle or square logo option. Read the screen ratios to determine the best one for you.

+
image::ROOT:onelg_logo.png[]
