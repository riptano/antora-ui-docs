...
. Once you have authenticated your service account, you can create and revoke tokens the link:_attachments/devopsv2.html[DevOps API].
...
xref:db-devops-roles.adoc#_create_a_new_role[Getting existing roles in your organization]. 
The API results will show the UUID for each role id.
====

Also refer to link:_attachments/devopsv2.html#operation/generateTokenForClient[Generate token for client] in the DevOps API.
