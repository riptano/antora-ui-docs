...
. Once you have authenticated your service account, you can add and removes regions in the link:_attachments/devopsv2.html[DevOps API].
...
Learn more about using xref:manage:db/managing-db.adoc#_using_multiple_regions[multiple regions].
