...
----
include::develop:example$graphql/createKeyspace.graphql[]
----
...
[source, plaintext, subs="attributes+"]
----
include::develop:example$graphql/1curl_createKeyspaceWithFile.sh[]
----
...
[source, plaintext, subs="attributes+"]
----
include::develop:example$graphql/createKeyspace.json[]
----
...
[source, plaintext, subs="attributes+"]
----
include::develop:example$graphql/1curl_createKeyspace.sh[]
----

[arabic, start=4]
. The last way to create schema is by deploying a schema file, as is shown on this
page in xref:graphql-first-using.adoc#_deploy_or_undeploy_schema[Deploy or undeploy schemas].
****
