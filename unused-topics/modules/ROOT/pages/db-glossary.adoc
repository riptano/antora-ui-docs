...
=== keyspace
The defining container for replication, similar to a schema in a relational database. All tables belong to a keyspace. See xref:planning.adoc#_astra_db_database_guardrails_and_limits[Guardrails & Limits page] for more info.
