...
xref:graphql-using-schema-first.adoc[GraphQL schema-first] section.
Stargate also automatically adds the following:
...
[source, shell, subs="attributes+"]
----
include::develop:example$graphql/1orders.js[tag=setup]
----
--
====
...
[source, shell, subs="attributes+"]
----
include::develop:example$graphql/1orders.js[tag=schema]
----
--
====
...
[source, shell, subs="attributes+"]
----
include::develop:example$graphql/1orders.js[tag=resolvers]
----
--
====
...
[source, shell, subs="attributes+"]
----
include::develop:example$graphql/1orders.js[tag=server]
----
--
====
...
[source, shell, subs="attributes+"]
----
include::develop:example$graphql/1orders.js[]
----
--
====
...
[source,shell, subs="attributes+"]
----
include::develop:example$graphql/1gateway.js[tag=gateway1]
----
--
Gateway2::
+
...
[source,shell, subs="attributes+"]
----
include::develop:example$graphql/1gateway.js[tag=gateway2]
----
--
Gateway3::
+
...
[source,shell, subs="attributes+"]
----
include::develop:example$graphql/1gateway.js[tag=gateway3]
----
--
====
...
[source,shell, subs="attributes+"]
----
include::develop:example$graphql/1gateway.js[]
----
--
====
...
[source, shell, subs="attributes+"]
----
include::develop:example$graphql/1fetchOrderById.graphql[]
----
--
Result::
+
...
[source, shell, subs="attributes+"]
----
include::develop:example$result/gql_1fetchOrderById.result[]
----
--
====
